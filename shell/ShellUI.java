...
public class ShellUI extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        // SHELL_BACK  (SHELL_BACK_COLOR SHELL_BORDER_COLOR)
        ...
        // Shell UP    (SHELL_UP_INSIDE, SHELL_UP_BORDER)
        ...
        // SHELL OWNER PLACEHOLDER   (OWNER) (SEPERATOR) (CLIENT_NAME) (SHELL_OWNER_COLOR)
        ...
        // POINTER (POINTER_INSIDE_COLOR POINTER_INSIDE_COLOR)
        RenderUtils.drawBorderedRect(textEnd, cursorY + 3, textEnd + 4, cursorY + 10, (blinkTicks > 5 ? _shell.getConfig().POINTER_INSIDE_COLOR : 0), _shell.getConfig().POINTER_BORDER_COLOR);

        // EXIT BUTTON (EXIT_BUTTON_COLOR EXIT_BUTTON_OVER_COLOR)
        ...
        // PROGRESS BAR (PROGRESS_BAR_COLOR)
    ...
    public void initGui() {
        Mouse.getDWheel();
        if (shellPosX == 0 && shellPosY == 0) {

            shellPosX = width / 2 - shellWidth / 2;
            shellPosY = height / 2 - shellHeight / 2;
        }
        super.initGui();
    }
