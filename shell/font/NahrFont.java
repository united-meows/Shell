...
public class NahrFont
{
    ...
    {
       NORMAL, SHADOW_THICK,  SHADOW_THIN
    }
            ...
            throws ArrayIndexOutOfBoundsException
    {
        ...
        drawTexturedModalRect(x, y, this.xPos[(character - this.startChar)],
                ...
                (float)bounds.getWidth() + 1.0F, (float)bounds.getHeight() +
    ...
    public float getStringWidth(String text)
    {
        ...
        return (float)(getBounds(StringUtils.stripControlCodes(text)).getWidth() + this.extraSpacing) / 2.0F;
    }
